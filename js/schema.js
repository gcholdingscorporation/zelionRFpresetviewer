...
(function (global) {
    ...
    var TABS = [
        ...
        /* The Configurator's rail ends at CLI. All Settings is the viewer's
         * one addition, and it earns its place: it is where a setting lives
         * when no Configurator page has a box for it. */
    ...
    var PG_TAB = {
        ...
        PG_DRIVER_FBUS_MASTER_CONFIG: 'all',
        PG_DRIVER_SPORT_MASTER_CONFIG: 'all',
        PG_CAMERA_CONTROL_CONFIG: 'all',
        PG_COMPASS_CONFIG: 'configuration',
        PG_CONTROL_RATE_PROFILES: 'rates',
        PG_CURRENT_SENSOR_ADC_CONFIG: 'power',
        PG_DASHBOARD_CONFIG: 'all',
        PG_DISPLAY_PORT_MAX7456_CONFIG: 'all',
        PG_DISPLAY_PORT_MSP_CONFIG: 'all',
        PG_DRIVER_SBUS_OUT_CONFIG: 'all',
        ...
        PG_SDIO_CONFIG: 'all',
        PG_SERIAL_CONFIG: 'all',
        PG_STATS_CONFIG: 'configuration',
        PG_STATUS_LED_CONFIG: 'all',
        ...
        PG_VTX_CONFIG: 'all',
        PG_VTX_IO_CONFIG: 'all',
        PG_VTX_SETTINGS_CONFIG: 'all'
    };
    ...
    var SECTIONS = [
        ...
        { tab: 'governor', title: 'Filters',
          names: ['gov_rpm_filter', 'gov_pwr_filter', 'gov_tta_filter',
                  'gov_d_filter', 'gov_ff_filter'] },
        { tab: 'governor', title: 'Governor Settings', profileScope: true,
        ...
        // ---- PID profiles --------------------------------------------------
                { tab: 'profiles', title: 'PID Controller Bandwidth', profileScope: true,
        ...
        { tab: 'profiles', title: 'PID Controller Settings', profileScope: true,
        ...
        { tab: 'profiles', title: 'Tail Rotor Settings', profileScope: true,
        ...
        { tab: 'profiles', title: 'Main Rotor Settings', profileScope: true,
          names: ['cyclic_cross_coupling_gain', 'cyclic_cross_coupling_ratio',
                  'cyclic_cross_coupling_cutoff'] },
        { tab: 'profiles', title: 'Auto-leveling Settings', profileScope: true,
