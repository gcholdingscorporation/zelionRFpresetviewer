    ...
    power: {
        boxes: [
            { title: 'Battery', rows: [
                ...
                { sub: 'Capacity [mAh]' },
                /* 4.6 keeps one capacity per battery profile; before that it
                 * was a single number, so the page had a single field. */
                { cli: 'bat_capacity', label: 'Capacity', unit: 'mAh', ver: '<4.6' },
                { cli: 'bat_capacity', idx: 0, label: 'Battery 1', unit: 'mAh',
                  active: 'bat_profile', ver: '>=4.6' },
                { cli: 'bat_capacity', idx: 1, label: 'Battery 2', unit: 'mAh',
                  active: 'bat_profile', ver: '>=4.6' },
                { cli: 'bat_capacity', idx: 2, label: 'Battery 3', unit: 'mAh',
                  active: 'bat_profile', ver: '>=4.6' },
                { cli: 'bat_capacity', idx: 3, label: 'Battery 4', unit: 'mAh',
                  active: 'bat_profile', ver: '>=4.6' },
                { cli: 'bat_capacity', idx: 4, label: 'Battery 5', unit: 'mAh',
                  active: 'bat_profile', ver: '>=4.6' },
                { cli: 'bat_capacity', idx: 5, label: 'Battery 6', unit: 'mAh',
                  active: 'bat_profile', ver: '>=4.6' }
            ] },
    ...
    motors: {
        ...
        boxes: [
            { title: 'Throttle', rows: [
                ...
                { sub: 'Throttle Range' },
                { cli: 'min_command', label: 'Motor Off', unit: 'μs', when: 'notDshot' },
                { cli: 'min_throttle', label: 'Low Throttle', unit: 'μs', when: 'notDshot' },
                { cli: 'max_throttle', label: 'High Throttle', unit: 'μs', when: 'notDshot' }
            ] },
